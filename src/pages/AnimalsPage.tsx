    ...
    <div className="max-w-7xl mx-auto px-4 py-12 bg-white">
      ...
      <section id="lions" className="mb-12">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <img
              src="https://plus.unsplash.com/premium_photo-1669725687221-6fe12c2da6b1?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8TGlvbnN8ZW58MHx8MHx8fDA%3D"
              alt="Lion"
              className="rounded-lg mb-4 w-full h-64 object-cover"
            />
            <h3 className="text-xl font-semibold mb-2">Lions</h3>
            <p className="text-gray-700">
              Lions are one of the most iconic big cats, known as the "King of the Jungle". They live in prides and are
              excellent hunters, working together to catch their prey. Adult males are easily recognizable by their impressive
              manes, which can vary in color from blonde to black.
            </p>
          </div>
          <div>
            <iframe
              className="w-full h-64 rounded-lg mb-4"
              src="https://www.youtube.com/embed/IPiyo332Gks"
              title="Lion Documentary"
              allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
              allowFullScreen
            ></iframe>
            <h3 className="text-xl font-semibold mb-2">Lion Behavior</h3>
            <p className="text-gray-700">
              Watch this fascinating documentary about lion behavior in the wild, their social structure, and hunting techniques.
              Lions are the only truly social cats, living in groups called prides that typically consist of related females,
